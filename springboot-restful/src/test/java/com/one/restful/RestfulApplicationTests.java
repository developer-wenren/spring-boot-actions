...
public class RestfulApplicationTests {
    ...
    public void saveMessage() throws Exception {
        for (int i = 0; i < 10; i++) {
            ...
            String contentAsString = mockMvc.perform(MockMvcRequestBuilders.post("/message").params(params)).andReturn().getResponse().getContentAsString();
        }
