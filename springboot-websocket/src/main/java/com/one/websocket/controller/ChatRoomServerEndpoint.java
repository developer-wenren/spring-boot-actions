...
import static com.one.websocket.util.WebSocketUtils.ONLINE_USER_SESSIONS;
import static com.one.websocket.util.WebSocketUtils.sendMessageAll;
...
public class ChatRoomServerEndpoint {
    ...
    @OnClose
    public void onClose(@PathParam("username") String username, Session session) { //当前的Session 移除
        ONLINE_USER_SESSIONS.remove(username); //并且通知其他⼈人当前⽤用户已经离开聊天室了了
